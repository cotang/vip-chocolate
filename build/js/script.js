...
function Particle(context) {
  ...
  this.update = function() {
    ...
    this.rotation += Math.PI / 13;
    this.currentopacity -= .0095;
    this.radius += growth;
...
function addParticle(context) {
  ...
  particle.setPosition(canvasWidth / 1+400, canvasHeight / 2 - 400);
...
function draw() {
  ...
  context.fillStyle = "rgba(0.8)";
  context.fillRect(0, 0, canvasWidth, canvasHeight);
  context.drawImage(cig, canvasWidth / 2 - 430, canvasHeight / 2 - 191, 860, 382);
